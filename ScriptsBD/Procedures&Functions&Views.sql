...
BEGIN
    INSERT INTO production_orders (id_labor, id_user, id_product, equipment_quantity, obs)
    VALUES (_id_labor, _id_user, _id_product, _equipment_quantity, _obs)
...
GROUP BY ci.id_client_invoice, ci.id_client, c.name, c.address, c.locality, c.postal_code, c.nif, ci.invoice_id, ci.invoice_date, ci.expire_date, ci.obs;
