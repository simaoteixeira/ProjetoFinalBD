...
class ProductionOrdersForm(forms.Form):
    ...
    equipment_quantity = forms.IntegerField(required=True, error_messages={'required': 'Campo obrigatório'})
    labor = forms.IntegerField(required=True, error_messages={'required': 'Campo obrigatório'})
